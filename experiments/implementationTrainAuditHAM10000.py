...
def main(args):
    ...
    data_dir = '/s/lovelace/c/nobackup/iray/dp-imgclass/HAM10000_noduplicates'
    ...
    net = timm.create_model(args.model, pretrained = True, num_classes = 7)
    ...
    sorted_indices = torch.argsort(Y, descending=False)
    T = torch.zeros(m)
